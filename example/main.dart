...
void main() async {
  ...
  globalLogProvider.get('test logger').emit(
      api.LogRecord(body: 'test otel log', severityNumber: api.Severity.error));
  globalLogProvider.get('test logger').emit(api.LogRecord(
      body: 'test otel log2', severityNumber: api.Severity.error));
